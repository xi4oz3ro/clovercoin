...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Clovercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"petitzero.com", "dnsseed.petitzero.com"},
    {"v-stat.com", "dnsseed.v-stat.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"clovercointools.com", "testnet-seed.clovercointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Clovercoin is probably already running."), addrBind.ToString().c_str());
        else
